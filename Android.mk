...
include $(CLEAR_VARS)
LOCAL_MODULE := qdcm_calib_data_Dual_nt35597_cmd_mode_dsi_panel_without_DSC
LOCAL_MODULE_OWNER := Gree
LOCAL_SRC_FILES := proprietary/etc/qdcm_calib_data_Dual_nt35597_cmd_mode_dsi_panel_without_DSC.xml
